...
<div id="hot_recommended">
    <span class="lf">求购信息</span>
    <a href="#"class="rt">更多求购></a>
</div>
<div id="product_show">
    <ul id="box_buy">
...
var loading="";
	$(function(){
		...
		$("#box_buy").empty().append(loading);
		//copy 复制一份 post ajax 形式
		   $.post("${pageContext.request.contextPath}/allBuymessage0",{startPage:0,pageSize:20},
				   function(data){
				
			     $("#box_buy").empty().append(data);
				...
				var options = { 
                      ...
                      onPageClicked: function (event, originalEvent, type, page){
                       $("#box_buy").empty().append(loading);
                         startPageTemp=page;
                         $.post("${pageContext.request.contextPath}/allBuymessage0",{startPage:page-1,pageSize:20},
                        function(data){
                         	 $("#box_buy").empty().append(data);
